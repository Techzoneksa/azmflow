...
import { Search, Filter, ChevronLeft, Copy, Phone, MapPin, Building2, User, Clock, CheckCircle2, XCircle } from "lucide-react";
...
import { SHIPMENTS, PARTNERS, STATUSES, STATUS_COLORS, type Shipment as ShipmentType } from "@/data/mock";
...
export default function ShipmentsPage() {
  ...
  const openSheet = useCallback((shipment: ShipmentType) => {
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>نقطة الاستلام</TableHead>
            ...
            <TableBody>
              {filtered.map((shipment) => (
                ...
                >
                  ...
                  <TableCell>
                    <span className="text-sm text-text-secondary">{shipment.pickupPoint}</span>
                  </TableCell>
                  <TableCell>
                    <div>
                  ...
                  <TableCell>
                    <Badge variant={STATUS_COLORS[shipment.status]}>
                      {shipment.status}
                    </Badge>
                  </TableCell>
                  <TableCell>
            ...
            <>
              <SheetHeader className="text-right mb-6">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <Badge variant={STATUS_COLORS[selectedShipment.status]}>
                ...
                <SheetDescription>
                  <span className="flex items-center gap-1.5 text-xs">
                    ...
                    تاريخ الإنشاء: {selectedShipment.createdAt}
                  </span>
                </SheetDescription>
              </SheetHeader>
              ...
              <div className="space-y-6">
                ...
                <Section title="معلومات العميل">
                  ...
                  <InfoRow icon={<MapPin className="h-4 w-4" />} label="العنوان" value={selectedShipment.customerAddress} />
                </Section>
